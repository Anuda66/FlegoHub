...
function Login() {
  ...
  return (
    <div>
      <form className="min-h-[80vh] flex items-center mt-30">
        <div className="flex flex-col items-center gap-3 p-8 m-auto min-w-[340px] sm:min-w-96 border border-gray-300 rounded-xl text-zinc-600 text-sm shadow-lg">
          ...
          <button type="submit" className="w-full pt-2 pb-2 text-base text-white transition duration-300 rounded-md bg-primary hover:bg-blue-700 hover:shadow-lg cursor-pointer">
